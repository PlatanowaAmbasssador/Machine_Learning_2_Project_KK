"""
CNN model implementation following BaseModel interface.
"""
...
class CNNModel(BaseModel):
    ...
    def build_model(
        ...
        """Build CNN model from hyperparameters."""
        num_filters = hyperparams.get("num_filters", [32, 64])
        kernel_sizes = hyperparams.get("kernel_sizes", [3, 3])
    ...
    def train_model(
        ...
        """Train CNN model and return model, scaler, and metrics."""
